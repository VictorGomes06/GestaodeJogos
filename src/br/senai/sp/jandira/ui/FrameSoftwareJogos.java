...
public class FrameSoftwareJogos extends JFrame {
	...
	public FrameSoftwareJogos() {
		...
		JComboBox<String> comboFabricante = new JComboBox<String>();
		...
		btnProximo.setBackground(Color.CYAN);
		...
		txtColeçãoJogos.setBackground(Color.CYAN);
		...
		JList<String> listJogos = new JList<String>(listModel);
		...
		JogoRepository colecao = new JogoRepository(10);
